...
function setPdt_add(){
	...
	if (sel_chk > 0) {
		...
		var addHTML = "";
			...
			addHTML +=	"	<td><textarea type=\"text\" name=\"gosi_content\" style=\"width:100%;\" class=\"pdt_id\" value=\"\" /></textarea></td>";
	...
	<div id="wrap">
		...
		<div id="admin_con_area">
			...
			<div class="admin_contents">
				...
				<input type="hidden" name="pdt_content" id="pdt_content" value="<%=pdt_content%>" >
