...
sql = sql & "		answer_content,answer_status, bbs_cate								"
...
<table id="tbl_write_main">
	...
	<tr class="view_tr_line">
		<td colspan="4" class="view_td_line">&nbsp;</td>
	</tr>
	<tr class="view_tr">
		<td class="view_td_title">글제목</td>
		<td class="view_td_colspan" colspan="3"><%=subject%></td>
	</tr>
	<tr class="view_tr">
		<td class="view_td_title">작성자</td>
		<td class="view_td_content"><%=username%></td>
		<td class="view_td_title">작성일시</td>
		<td class="view_td_content"><%=work_date%></td>
	</tr>
	<%If bbs_cate <> "" Then%>
	<tr class="view_tr">
		<td class="view_td_title">게시물구분</td>
		<td class="view_td_content" colspan="3"><%=bbs_cate%></td>
	</tr>
	<%End If%>
	<%If bbs_type="P" Then%>
	<tr class="view_tr">
		<td class="view_td_title">답변여부</td>
		<td class="view_td_content" colspan="3">
		<%If answer_status="0" Then Response.Write "미답변" Else Response.Write "답변완료" End if%>
		</td>
	</tr>
	<%End If %>
	<% If file_cnt > 0 Then %>
	<tr class="view_tr">
		<td class="view_td_title">첨부자료</td>
		<td class="view_td_colspan" colspan="3">
			<%
	...
	<% If bbs_type = "F" Then %>
	<tr class="view_tr">
		<td class="view_td_title">전화번호</td>
		<td class="view_td_content"><%=tel_str%></td>
		<td class="view_td_title">E-Mail</td>
		<td class="view_td_content"><%=email%></td>
	</tr>
	<% End If %>

	<tr class="view_tr">
		<td class="view_td_full" colspan="4" style="width:730px; border-bottom:1px dotted #cacaca;padding-top:20px; padding-bottom:20px;">
			<div style="width:730px; border:none; overflow:hidden; overflow-x:auto;">
			<%=content%>
			</div>
		</td>
	</tr>
...
<table id="tbl_write_main">
	...
	<tr class="view_tr_line">
		<td colspan="2" class="view_td_line">&nbsp;</td>
	</tr>
	<tr class="view_tr">
		<td class="view_td_title">이전글&nbsp;▲</td>
		<td class="view_td_colspan"><%=prev_subject%></td>
	</tr>
	<tr class="view_tr">
		<td class="view_td_title">다음글&nbsp;▼</td>
		<td class="view_td_colspan"><%=next_subject%></td>
	</tr>
</table>
-->
<!----------------------------------------- Preview / Next E ------------------------------------>
