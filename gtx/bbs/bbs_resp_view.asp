            	...
            	<div class="">
                    <div class="view_page">
                    	...
                    	<table id="table_content" border="0" cellspacing="0" cellpadding="0"  class="tb_common02 tb_oder_cart">
                            <tr>
                                ...
                                <td style="text-align:left; padding-left:10px; width:*;"><%=subject%></td>
                            </tr>
                            <tr>
                                <th class="txt_ct" style="width:130px;">작성자</td>
                                <td style="text-align:left; padding-left:10px;" ><%=username%></td>

                            </tr>
                            <tr>
                                <th class="txt_ct" style="width:130px;">작성일시</td>
                                <td style="text-align:left; padding-left:10px;" ><%=work_date%></td>

                            </tr>
							<%If bbs_type="P" Then%>
                            <tr>
                                <th class="txt_ct" >답변여부</td>
                                <td style="text-align:left; padding-left:10px;" ><%If answer_status="0" Then Response.Write "미답변" Else Response.Write "답변완료" End if%></td>
							...
							<% If bbs_type = "F" Then %>
							<tr>
                                <th class="txt_ct" style="width:130px;">전화번호</td>
                                <td ><%=tel_str%></td>
                            </tr>
							<tr>
                                <th class="txt_ct" style="width:130px;">E-Mail</td>
                                <td >
								<%=email%>
								</td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2" style="border-bottom:1px dotted #cacaca;padding-top:20px; padding-bottom:20px;">
								<div class="bbs_con" style="width:100%; border:none; overflow:hidden; overflow-x:auto;text-align:justify;" >
								<%=content%>
								</div>
								</td>
                            </tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr class="command_tr">
							...
							<td class="command_td_R" style="text-align:right;">
								<img src="./img/btn_list.gif" border="0" style="margin:20px 0;cursor:pointer;" onClick="command_link('list');">
							</td>
						</tr>
						</form>
					</table>
	...
	<script language="javascript">
		...
		function secret_article() {
			...
			if (pass.value == "") {
				...
				{
					var url_	= "./bbs_resp_edit.asp?" + query;
				}
		...
		$(document).ready(function() {
			$(".bbs_con").find("img").each(function() {
